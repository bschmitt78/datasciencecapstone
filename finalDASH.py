...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            options=dropdown_options, #[{'label': i, 'value': i} for i in dropdown_options],
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        ...
        R_chart3 = dcc.Graph(
                 ...
                 names='Vehicle_Type',
                 title="Total Ad Spending Share by Vehicle Type"
                )
        )
...
# Plot 2 Total Monthly Automobile sales using line chart.
        mas = data.groupby(['Year', 'Month'])['Automobile_Sales'].mean().reset_index()
        ...
        Y_chart3 = dcc.Graph( figure=px.bar(unemp_sales, 
                                            x='Vehicle_Type', 
                                            y='Automobile_Sales',
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_rec,
                                values='Advertising_Expenditure',
                                names='Vehicle_Type',
                                title='Total Ad Spending Share by Vehicle Type for Year {}'.format(input_year)))
